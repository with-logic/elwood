...
on an accepted hook (the matching `UserPromptSubmit` or a `Stop` boundary), or to
the first tagged content event if none arrived earlier. Later differently tagged
