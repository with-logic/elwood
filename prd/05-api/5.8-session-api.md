...
loop has already been selected for submission, a later caller waits for its physical
submission to settle, completion, and trailing transcript drain before attaching
its collector or submitting. Successive loops wait for the preceding loop's drain
before installing another observer or submitting; callers wait behind all earlier
loop reservations.
