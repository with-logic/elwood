...
the failure can still open it, so Elwood holds the slot for that same bounded
second, cancelling a dialog that appears late. If it remains, normal queued input stays held while
