...
intermediate `ready` event; otherwise it settles to `ready` because the composer
is idle. Initial readiness requested behind a dialog remains deferred while the
clearance frame shows work. If a caller prompt was held behind the dialog, its
