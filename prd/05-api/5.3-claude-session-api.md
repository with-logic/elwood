...
physical caller submission before notifying observers or invoking handlers. If a newer
caller prompt is physically submitted while that Stop is being handled, the older Stop
