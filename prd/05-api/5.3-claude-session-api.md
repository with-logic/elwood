...
Ownership covers the operation's lifetime: a failed operation releases the slot as
soon as it rejects, and a dialog it left open is not cancelled by this criterion.
