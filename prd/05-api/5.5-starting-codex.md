...
and a completion from an earlier generation never re-arms the current one. A rejected
PTY write, or a safe option that has not painted yet, stays retryable within the
generation. A blocked update screen therefore becomes a bounded run
