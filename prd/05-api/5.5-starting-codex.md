...
eligibility. A changed first-party version banner supersedes the prior appearance
without a clear frame. Captured retries reject the changed banner before another
write; the new appearance may start its own bounded attempt. Each appearance of the
