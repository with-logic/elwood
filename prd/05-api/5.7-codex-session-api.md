...
startup-only: once any assistant row has rendered, no later frame is a warning
source, so a copied welcome region whose conversation marker has scrolled away
