...
type ElwoodWarningEvent =
  ...
  | {
      ...
      // Bounded termination diagnostic; never process stderr or arbitrary error text.
      readonly cleanupErrorCode?: "EPERM" | "ESRCH" | "EINVAL" | "EACCES" | "EAGAIN"
        | "Error" | "TypeError" | "RangeError" | "ReferenceError" | "UnknownError" | "ETIMEDOUT";
      readonly raw: string;
    }
  | {
      readonly elwoodSessionId: string;
