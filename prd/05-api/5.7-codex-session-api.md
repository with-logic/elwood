...
`hook_observer_failed` reports the first contained notification failure in one Claude
hook invocation. Its message is fixed and `raw` is `hook_observer_failed phase=<phase>`; neither
