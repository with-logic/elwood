...
NOT authorize a different active dialog. Wrapped headers and descriptive blank
rows within a dialog remain supported. Numbered layouts are answered by sending
...
approve a replacement permission dialog. Elwood matches only against the CURRENT
