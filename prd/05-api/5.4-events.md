...
approve a replacement permission dialog. With a live frame reader, both numbered
and cursor trust responses wait for the dialog to clear before reporting success.
A numbered answer that leaves the same dialog visible is retried at bounded
intervals within a five-second attempt; each retry revalidates the same native
header and affirmative choice. If live revalidation fails or the bounded attempt
expires, automation cancels quietly and remains retryable,
