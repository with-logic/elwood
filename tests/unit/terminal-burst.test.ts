/** Real PTY output survives rendering batches and process exit (PRD §4.1, C-PERF-05). */
...
test("C-PERF-05 a real PTY burst renders every byte and the final frame before settling", async () => {
...
test("C-PERF-05 a real PTY pauses while rendering stalls and resumes without loss", async () => {
