...
describe("interactiveLaunch", () => {
  test("C-CLI-25 omits built-in posture and passes explicit Claude settings as native flags", () => {
  ...
  test("C-CLI-25 without resolution provenance no posture is forwarded", () => {
  ...
  test("C-CLI-25 resumes a stored Claude record with merged posture and its conversation id", () => {
  ...
  test("C-CLI-25 maps Codex posture, effort, and resume through the shared builder", () => {
