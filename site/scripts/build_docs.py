...
<main id="content" tabindex="-1"><article>{''.join(sections)}</article><footer class="docs-footer">Prompted with <svg class="mark-heart" viewBox="0 0 24 24" role="img" aria-label="love"><path d="M12 21C6.5 16.9 3 13.8 3 9.9 3 7.1 5.2 5 8 5c1.6 0 3.1.8 4 2 .9-1.2 2.4-2 4-2 2.8 0 5 2.1 5 4.9 0 3.9-3.5 7-9 11.1z"/></svg> by <a href="https://logic.inc">Logic, Inc</a> in Seattle, WA <svg class="mark-needle" viewBox="0 0 24 24" role="img" aria-label="Seattle"><path d="M10.9 14.2h1.05l-.9 8.6H8.7zM12.05 14.2h1.05l2.25 8.6h-2.35z"/><path d="M11.55 14.2h.9v8.6h-.9z"/><path d="M4.6 11.2c0-1.45 3.3-2.35 7.4-2.35s7.4.9 7.4 2.35c0 .72-.9 1.2-2.3 1.5a27 27 0 0 1-10.2 0c-1.4-.3-2.3-.78-2.3-1.5z"/><path d="M11.62 3.4h.76v5.5h-.76z"/><path d="M12 1 12.7 3.2h-1.4z"/></svg>. MIT licensed. <a href="https://github.com/with-logic/elwood">GitHub ↗</a></footer></main><aside class="docs-tools" aria-label="Copy and export"><p>For your agent</p><button class="tool-copy" id="copy-all-side" type="button">Copy docs as Markdown</button><a class="plain-text" href="../llms-full.txt">llms-full.txt</a><a class="plain-text" href="../llms.txt">llms.txt</a></aside></div>
