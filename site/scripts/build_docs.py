...
def build():
    ...
    for slug, label in PAGES:
        ...
        sections.append(f'<section class="doc-section" id="{slug}" aria-labelledby="{slug}--title"><div class="section-tools"><span>{html.escape(label)}</span><button class="copy-section" data-slug="{slug}">Copy as Markdown</button><a href="/guide/{slug}.md">.md</a></div>{body}</section>')
    ...
    # Vercel serves /guide without a slash; asset paths must not depend on it.
    page = f'''<!doctype html>
<html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="theme-color" content="#ffda1a"><link rel="icon" href="../assets/landing/favicon.ico?v=yellow" sizes="16x16 32x32 48x48"><link rel="icon" href="../assets/landing/icon-512.webp?v=yellow" type="image/webp" sizes="512x512"><link rel="apple-touch-icon" href="../assets/landing/apple-touch-icon.png?v=yellow"><link rel="manifest" href="../assets/landing/site.webmanifest"><meta name="description" content="Documentation for the Elwood TypeScript library and CLI: what it does, how it does it, and how to use it."><meta property="og:title" content="Elwood documentation"><meta property="og:type" content="website"><meta property="og:image" content="https://elwood.bot/assets/landing/social-card.png?v=yellow"><meta name="twitter:card" content="summary_large_image"><title>Elwood documentation</title><link rel="stylesheet" href="../theme.css"><link rel="stylesheet" href="/guide/guide.css"></head>
...
<main id="content" tabindex="-1"><article>{''.join(sections)}</article><footer class="docs-footer">Prompted with <svg class="mark-heart" viewBox="0 0 24 24" role="img" aria-label="love"><path d="M12 21C6.5 16.9 3 13.8 3 9.9 3 7.1 5.2 5 8 5c1.6 0 3.1.8 4 2 .9-1.2 2.4-2 4-2 2.8 0 5 2.1 5 4.9 0 3.9-3.5 7-9 11.1z"/></svg> by <a href="https://logic.inc">Logic, Inc</a> in Seattle, WA <svg class="mark-needle" viewBox="0 0 24 24" role="img" aria-label="Seattle"><g fill="currentColor"><path d="M8.7 23.4 10.9 13.9h.68l-1.1 9.5z"/><path d="M15.3 23.4 13.1 13.9h-.68l1.1 9.5z"/><path d="M11.6 13.9h.8v9.5h-.8z"/><path d="M11.15 12.1h1.7v2.1h-1.7z"/><path d="M12 8.5c3.85 0 6.95.92 6.95 2.05 0 .5-.62.86-1.4 1.08-1.3.37-3.3.6-5.55.6s-4.25-.23-5.55-.6c-.78-.22-1.4-.58-1.4-1.08C5.05 9.42 8.15 8.5 12 8.5z"/><path d="M11.58 8.75h.84V4.5h-.84z"/><path d="M12 1.2l.58 3.3h-1.16z"/></g></svg>. MIT licensed. <a href="https://github.com/with-logic/elwood">GitHub ↗</a></footer></main><aside class="docs-tools" aria-label="Copy and export"><p>For your agent</p><button class="tool-copy" id="copy-all-side" type="button">Copy docs as Markdown</button><a class="plain-text" href="../llms-full.txt">llms-full.txt</a><a class="plain-text" href="../llms.txt">llms.txt</a></aside></div>
<dialog id="docs-search" aria-labelledby="search-title"><div class="search-heading"><h2 id="search-title">Search</h2><button id="search-close" aria-label="Close search">×</button></div><label for="search-query">Search the documentation</label><input id="search-query" type="search" placeholder="streaming, timeout, resume…" autocomplete="off"><p id="search-status" role="status"></p><ul id="search-results"></ul></dialog><script type="module" src="/guide/guide.mjs"></script></body></html>'''
