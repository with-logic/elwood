...
def build():
    ...
    page = f'''<!doctype html>
<html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="theme-color" content="#fbf6e7"><meta name="description" content="Documentation for the Elwood TypeScript library and CLI: what it does, how it does it, and how to use it."><title>Elwood documentation</title><link rel="stylesheet" href="guide.css"></head>
