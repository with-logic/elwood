...
<main id="content" tabindex="-1"><article>{''.join(sections)}</article><footer class="docs-footer">Prompted with love by <a href="https://logic.inc">Logic, Inc</a> in Seattle, WA. MIT licensed. <a href="https://github.com/with-logic/elwood">GitHub ↗</a></footer></main><aside class="docs-tools" aria-label="Copy and export"><p>For your agent</p><button class="tool-copy" id="copy-all-side" type="button">Copy docs as Markdown</button><a class="plain-text" href="../llms-full.txt">llms-full.txt</a><a class="plain-text" href="../llms.txt">llms.txt</a></aside></div>
