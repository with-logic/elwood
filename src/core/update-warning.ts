 ...
 * when the installed CLI is compatible) and surfaced as this live warning with SAFE diagnostics
 * only — the installed version in use, an allowlisted error code, and bounded stderr — never
 * transcripts, prompts, tokens, or secrets.
 */
