/**
 * The Claude hook-bridge message and error handlers, extracted from `session.ts`
 * to keep it within the file-size cap. Implements PRD §5.3, §5.4, §6, and §8:
...
import type { HookErrorEvent, StartClaudeOptions } from "../core/types.ts";
import type { TypedEmitter } from "../events/emitter.ts";
import type { InitialReady } from "../runtime/initial-ready.ts";
...
import type { ClaudeSessionImpl } from "./session-instance.ts";
